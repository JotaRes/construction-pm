    ...
    <div className="space-y-5">
      ...
      <form onSubmit={handleCreate} className="bg-white border border-slate-200 rounded-xl p-4 space-y-3">
        ...
        <button type="submit" disabled={!newTitle.trim() || createMut.isPending}
          className="flex items-center gap-2 px-4 py-2 bg-[var(--brand-gold)] hover:bg-[#4A6880] text-white text-sm font-semibold rounded-lg transition-colors disabled:opacity-40">
