  ...
  if (editing) {
    return (
      <input
        ...
        className="w-full bg-white border border-[#1D1D1F]/40 text-xs font-mono text-right text-slate-900 px-1.5 py-0.5 rounded focus:outline-none focus:border-[var(--brand-gold)]"
        autoFocus
      />
    )
  }
