        ...
        <div className="p-6 border-b border-slate-100 space-y-3">
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => fileRef.current?.click()}
              className="flex items-center gap-2 text-xs text-slate-500 hover:text-[var(--brand-gold)] border border-slate-200 hover:border-[#0071E3]/40 px-3 py-1.5 rounded-lg transition-colors">
            ...
            <button onClick={() => addMut.mutate()} disabled={addMut.isPending || !file}
              className="flex items-center gap-2 px-4 py-1.5 bg-[var(--brand-gold)] hover:bg-[#0077ED] text-white text-xs font-semibold rounded-lg transition-colors disabled:opacity-50">
...
function ProviderCard({ provider, projectId, billing, onUpdate, onDelete }: {
  ...
  if (editing) {
    return (
      <div className="bg-white border border-[#0071E3]/40 rounded-xl p-4 space-y-3">
        <div className="grid grid-cols-2 gap-2">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] px-1.5 py-0.5 rounded-full font-semibold" style={{ background: provider.projectId ? 'rgba(0,113,227,0.12)' : 'rgba(29,29,31,0.08)', color: provider.projectId ? 'var(--brand-gold)' : 'var(--brand-teal2)' }}>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button onClick={() => setShowDocs(true)}
              className="flex items-center gap-1.5 text-[10px] text-[var(--brand-gold)] border border-[#0071E3]/40 px-2.5 py-1.5 rounded-lg hover:bg-[#0071E3]/5 transition-colors">
    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => setShowAdd(true)}
          className="flex items-center gap-2 bg-[var(--brand-gold)] hover:bg-[#0077ED] text-white text-sm px-4 py-2 rounded-xl transition-colors">
