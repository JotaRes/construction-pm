...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  'Plumbing': 'bg-[#C8922A]/20 text-blue-300',
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200/30">
                ...
                <th className="px-3 py-1.5 text-right text-[9px] text-[#C8922A]/60 uppercase tracking-wider w-24">Promedio</th>
                ...
                return (
                  <tr key={ref.id} className="border-b border-slate-200/20 hover:bg-white/40 transition-colors group">
                    ...
                    <td className="px-3 py-2 text-right">
                      <span className={`text-xs font-mono ${mid > 0 ? 'text-[#C8922A]/80' : 'text-slate-500'}`}>
                        {mid > 0 ? formatUSD(mid) : '—'}
                      </span>
                    </td>
                    <td className="px-3 py-2">
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs px-2 py-1.5 rounded-lg focus:outline-none focus:border-[#C8922A]/60"
          >
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs px-2 py-1.5 rounded-lg focus:outline-none focus:border-[#C8922A]/60 placeholder-slate-400"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" value={form.priceLow} onChange={e => set('priceLow', e.target.value)}
            placeholder="0.00"
            className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs px-2 py-1.5 rounded-lg focus:outline-none focus:border-[#C8922A]/60 font-mono placeholder-slate-400" />
        </div>
        <div>
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-white border border-slate-200 text-xs text-slate-800 rounded-xl focus:outline-none focus:border-[#C8922A]/60 placeholder-slate-400"
          />
        </div>
