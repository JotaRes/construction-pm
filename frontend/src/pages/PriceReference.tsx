...
const CATEGORY_COLORS: Record<string, string> = {
  ...
  'Plumbing': 'bg-[#2E6BB4]/20 text-blue-300',
  ...
  'General Conditions': 'bg-[#2E6BB4]/10 text-[var(--brand-gold)]',
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200/30">
                ...
                <th className="px-3 py-1.5 text-right text-[9px] text-[#2E6BB4]/60 uppercase tracking-wider w-24">Promedio</th>
                ...
                return (
                  <tr key={ref.id} className="border-b border-slate-200/20 hover:bg-white/40 transition-colors group">
                    ...
                    <td className="px-3 py-2 text-right">
                      <span className={`text-xs font-mono ${mid > 0 ? 'text-[#2E6BB4]/80' : 'text-slate-500'}`}>
                        {mid > 0 ? formatUSD(mid) : '—'}
                      </span>
                    </td>
                    <td className="px-3 py-2">
    ...
    <div className="bg-white/60 border border-amber-500/20 rounded-2xl p-5 mb-4">
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <div>
          ...
          <select
            ...
            className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs px-2 py-1.5 rounded-lg focus:outline-none focus:border-[#2E6BB4]/60"
          >
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs px-2 py-1.5 rounded-lg focus:outline-none focus:border-[#2E6BB4]/60 placeholder-slate-400"
          />
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" value={form.priceLow} onChange={e => set('priceLow', e.target.value)}
            placeholder="0.00"
            className="w-full bg-slate-50 border border-slate-200 text-slate-800 text-xs px-2 py-1.5 rounded-lg focus:outline-none focus:border-[#2E6BB4]/60 font-mono placeholder-slate-400" />
        </div>
        <div>
      ...
      <div className="flex gap-2 justify-end">
        ...
        <button
          ...
          className="px-4 py-1.5 bg-[var(--brand-gold)] hover:bg-[#4A86CF] text-white text-xs font-medium rounded-lg transition-colors"
        >
          Guardar
        </button>
      </div>
...
export default function PriceReference() {
  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex items-center gap-2">
          ...
          {view === 'manual' && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[var(--brand-gold)] hover:bg-[#4A86CF] text-white text-sm font-medium rounded-xl transition-colors"
            >
      ...
      {view === 'auto' && (
        <div className="section-card p-3 flex items-start gap-2" style={{ background: 'rgba(46,107,180,0.05)' }}>
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1 max-w-xs">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-white border border-slate-200 text-xs text-slate-800 rounded-xl focus:outline-none focus:border-[#2E6BB4]/60 placeholder-slate-400"
          />
        </div>
        <div className="flex flex-wrap gap-1.5">
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors
              ${filterCat === 'ALL' ? 'bg-[#2E6BB4]/10 text-[var(--brand-teal)] border border-amber-500/40' : 'text-slate-500 hover:text-slate-800 bg-white/50'}`}
          >
            Todas
          </button>
          {categories.map(c => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors
                ${filterCat === c ? 'bg-[#2E6BB4]/10 text-[var(--brand-teal)] border border-amber-500/40' : 'text-slate-500 hover:text-slate-800 bg-white/50'}`}
            >
              {c}
            </button>
          ))}
      ...
      {byCategory.size === 0 ? (
        <div className="text-center py-20 text-slate-400">
          ...
          <button
            ...
            className="mt-4 px-4 py-2 bg-[#2E6BB4]/10 text-[var(--brand-gold)] border border-amber-500/30 rounded-xl text-sm hover:bg-blue-600/30 transition-colors"
          >
