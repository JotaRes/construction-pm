        ...
        <div className="p-6">
          <div className="flex items-start justify-between flex-wrap gap-4">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-xl flex items-center justify-center" style={{ background: 'rgba(62,90,112,0.12)', color: 'var(--brand-gold)' }}>
                <Building2 size={28} />
              </div>
              <div>
                ...
                <div className="flex items-center gap-2 text-sm mt-1" style={{ color: 'var(--brand-teal2)' }}>
                  ...
                  <span className="badge ml-2" style={{ background: 'rgba(62,90,112,0.12)', color: 'var(--brand-gold)', border: '1px solid rgba(62,90,112,0.3)' }}>{account.type}</span>
                </div>
              </div>
            </div>
                      ...
                      return (
                        <tr key={`${m.id}-${m._isIncoming ? 'in' : 'out'}`} className="table-row" style={{ borderBottom: '1px solid rgba(29,29,31,0.06)' }}>
                          ...
                          <td className="px-4 py-3">
                            ...
                            )} style={isTransfer ? { background: 'rgba(62,90,112,0.1)', color: 'var(--brand-gold)' } : {}}>
