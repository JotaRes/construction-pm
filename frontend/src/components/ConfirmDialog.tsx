            ...
            <div className="px-6 py-5">
              ...
              <div className="flex items-start gap-3 mb-3">
                <div
                  ...
                  style={{
                    background: isDestructive ? 'rgba(220,38,38,0.1)' : 'rgba(62,107,133,0.12)',
              ...
              <div className="flex justify-end gap-2 pt-3" style={{ borderTop: '1px solid rgba(45,75,82,0.08)' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: isDestructive ? '0 4px 14px rgba(220,38,38,0.25)' : '0 4px 14px rgba(62,107,133,0.25)',
                  }}
                  autoFocus={!needsType}
                >
