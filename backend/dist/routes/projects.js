...
const phasesTemplate_1 = require("../data/phasesTemplate");
...
router.post('/', async (req, res) => {
    try {
        ...
        for (let pi = 0; pi < phasesTemplate_1.PHASES_TEMPLATE.length; pi++) {
            const pt = phasesTemplate_1.PHASES_TEMPLATE[pi];
        ...
        for (let i = 0; i < phasesTemplate_1.INSPECTIONS_TEMPLATE.length; i++) {
            const ins = phasesTemplate_1.INSPECTIONS_TEMPLATE[i];
